...
public class GroceriesResource {
    ...
    @Operation(
            summary = "Finds a Grocery by its Id",
            description = "Finds a Grocery by its Id, it also consumes the Stock service to return"
            + "the stock availability of the Grocery. If no Grocery is found a 404 is return")
    public Groceries findById(@Parameter(description = "The Id of the Grocery", required = true)
