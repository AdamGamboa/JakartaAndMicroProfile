...
public class BookResource {
    ...
    @Operation(
            ...
            description = "Finds a book by its Id, it also consumes the Stock service to return"
            + "the stock availability of the book. If no book is found a 404 is return")
    public Book findById(@Parameter(description = "The Id of the Book ", required = true)
